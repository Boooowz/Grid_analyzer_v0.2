...
def analyze_excel(input_path: str | Path,
    ...
    for r in range(2, ws.max_row + 1):
        ...
        for start_dt, end_dt in intervals:
            ...
            # Οι νυχτερινές ώρες που πέφτουν σε Κυριακή/αργία ανήκουν στις «Νυχτερινές Κυριακής».
            # Δεν διπλομετρώνται στις απλές νυχτερινές.
            gross_nh = max(0.0, gross_nh - gross_snh)
...
def write_summary_xlsx(output_path: str | Path, summaries: List[EmployeeSummary], details: List[DetailRow], excluded_rows: List[ExcludedRow], warnings: List[str]):
    ...
    info_rows = [
        ...
        ["Νυχτερινές ώρες", "22:00 έως 06:00, ΕΚΤΟΣ Κυριακής/αργίας. Όσες νυχτερινές πέφτουν σε Κυριακή/αργία μετριούνται μόνο στις «Νυχτερινές ώρες Κυριακής»."],
        ["Κυριακή", "Ημερολογιακή Κυριακή 00:00 έως 24:00. Οι βάρδιες που περνούν τα μεσάνυχτα σπάνε χρονικά. Π.χ. Σάββατο 21:00 – Κυριακή 01:00 = 4 ώρες σύνολο: 2 νυχτερινές (22-24 Σαβ.), 1 ώρα Κυριακής και 1 ώρα νυχτερινό Κυριακής (η ίδια 00-01)."],
        ...
        ["Νυχτερινές ώρες Κυριακής", "Ώρες 22:00-06:00 που πέφτουν σε Κυριακή ή αργία. Είναι ξεχωριστή στήλη — δεν διπλομετρώνται στις απλές «Νυχτερινές ώρες»."],
...
def launch_streamlit_app():
    ...
    try:
        ...
        with st.expander("Κανόνες υπολογισμού"):
            ...
            st.write("• Νυχτερινές: ώρες 22:00–06:00 ΕΚΤΟΣ Κυριακής/αργίας. Όσες πέφτουν σε Κυριακή/αργία μετριούνται μόνο στις «Νυχτερινές Κυριακής» — δεν διπλομετρώνται.")
            st.write("• Η Κυριακή υπολογίζεται ημερολογιακά, από 00:00 έως 24:00.")
            st.write("• Βάρδιες που περνούν τα μεσάνυχτα σπάνε χρονικά. Π.χ. Σάββατο 21:00 – Κυριακή 01:00 = 4 ώρες σύνολο: 2 νυχτερινές (22-24 Σαβ.), 1 ώρα Κυριακής (00-01 Κυρ.) και 1 ώρα νυχτερινό Κυριακής (η ίδια 00-01).")
