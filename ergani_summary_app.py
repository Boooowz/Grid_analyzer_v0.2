...
def write_summary_xlsx(output_path: str | Path, summaries: List[EmployeeSummary], details: List[DetailRow], excluded_rows: List[ExcludedRow], warnings: List[str]):
    ...
    info_rows = [
        ...
        ["Κυριακή", "Ημερολογιακή Κυριακή 00:00 έως 24:00. Οι βάρδιες που περνούν τα μεσάνυχτα σπάνε χρονικά. Π.χ. Σάββατο 21:00 – Κυριακή 01:00 = 4 ώρες σύνολο, εκ των οποίων 3 νυχτερινές, 1 ώρα Κυριακής και 1 ώρα νυχτερινό Κυριακής."],
        ...
        ["Νυχτερινές ώρες Κυριακής", "Μόνο οι ώρες που είναι ταυτόχρονα Κυριακή/αργία και νυχτερινές: 00:00-06:00 και 22:00-24:00. Η ίδια ώρα μετριέται και ως νυχτερινή και ως νυχτερινή Κυριακής."],
...
def launch_streamlit_app():
    ...
    try:
        ...
        with st.expander("Κανόνες υπολογισμού"):
            ...
            st.write("• Βάρδιες που περνούν τα μεσάνυχτα σπάνε χρονικά. Π.χ. Σάββατο 21:00 – Κυριακή 01:00: 3 νυχτερινές, 1 ώρα Κυριακής και 1 ώρα νυχτερινό Κυριακής (η ίδια ώρα 00:00-01:00 καταγράφεται και στις δύο στήλες).")
